...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="state.pkl",
        help="The state includes the generated texts and the current batch number, which allows the script to resume generating text from the last saved state in case the script is interrupted.",
    )
